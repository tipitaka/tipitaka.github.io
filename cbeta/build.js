...
require.register("cbeta2014-main/index.js", function(exports, require, module){
/** @jsx React.DOM */
/*
   SPEC : 
     檔名過慮功能。
...
var main = React.createClass({displayName: 'main',
  ...
  renderinputs:function() {  // input interface for search
    if (this.state.db) {
      return (   
        //"則為正"  "為正觀" both ok
        React.DOM.div(null, React.DOM.input( {onKeyPress:this.keypress, ref:"tofind", defaultValue:"則為正觀"}),
...
require.register("cbeta2014-comp1/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
require.register("cbeta2014-maintext/index.js", function(exports, require, module){
/** @jsx React.DOM */

//var othercomponent=Require("other"); 
var maintext = React.createClass({displayName: 'maintext',
  getInitialState: function() {
    return {bar: "world"}; 
  },  
  render: function() {   
    return (
      React.DOM.div( {className:"maintext"},  
React.DOM.span( {className:"l"}, "此瑜伽經大分爲二。初偈頌總相歸讃。次長"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "行等自他利行。於諸頌中復分爲二。初偈四"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "句普歸命三寶[應知]次下別歸聖會。於中復爲"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "二。先十句歸命五分如來。後十句歸四大菩"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "薩。初十句中金剛身語意等四句歸讃毘盧"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "遮那佛。次雄猛阿閦已下六句歸四方如來"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "[應知]後十句歸四大菩薩。於中初二句讃禮金"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "剛藏菩薩。次二句讃禮虚空藏菩薩。第三兩"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "句讃禮觀世音菩薩。第四兩句讃禮毘首羯"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "磨菩薩。第五兩句結徳總歸[應知]此上兩句等西"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "方集瑜伽者大阿闍梨先以勝相讃禮置之經"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "首。一切經首皆隨彼門先安讃禮偈此方先"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "徳略而不譯[應知]次我今於百千頌金剛頂等總"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "四十字述經題目。此經有百干頌廣本。非此"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "土所聞。並是諸佛大菩薩等甚深祕密境界"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "相。亦非聲聞縁覺及人天小智之所聞知。此"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "地梵網經兩卷從此經中出淺略之行相也。"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "其中廣相根未有堪。此略瑜伽西國得灌頂"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "者説授相付。而其廣本亦不傳之。其百千頌"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "本復是菩薩大藏經中次略也。其大經本。阿"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "闍梨云經夾廣長如床。厚四五尺有無量頌。"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "在南天竺界鐵塔之中佛滅度後數百年間無"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "人能開此塔。以鐵扉鐵鎖而封閉之。其中天"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "竺國佛法漸衰。時有大徳先誦持大毘盧遮"),React.DOM.br(null),
React.DOM.hr(null),
React.DOM.span( {className:"l"}, "那眞言。得毘盧遮那佛而現其身及現多身。"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "於虚空中説此法門及文字章句。次第令寫"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "訖即滅。即今毘盧遮那念誦法要一卷。是時"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "此大徳持誦成就願開此塔。於七日中遶塔"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "念誦。以白芥子七粒打此塔門乃開。塔内諸"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "神一時踊怒不令得入。唯見塔内香燈光明"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "一丈二丈。名華寶蓋滿中懸列。又聞讃聲讃"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "此經王。時此大徳至心懺悔發大誓願然後"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "得入此塔中。入已其塔尋閉。經於多日讃此"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "經王廣本一遍爲如食頃。得諸佛菩薩指授"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "所堪記持不忘。便令出塔塔門還閉如故。爾"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "時書寫所記持法有百千頌。此經名金剛頂"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "經者菩薩大藏塔内廣本絶世所無。塔内燈"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "光明等至今不滅此經百千頌本此國未有。"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "此略本至此土者於開元之初金剛菩提三藏"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "阿闍梨云。我從西國發來度於南海其有大"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "船三十餘隻。一一皆有五六百人。一時同過"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "大海行至海中逢於大風。諸船及人並皆漂"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "沒。我所附船亦欲將沒。爾時兩本經夾常近"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "於身受持供養。其時船主見船欲沒。船上諸"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "物皆擲海中。當時怖懼忘收經夾。其百千頌"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "亦擲海中唯存略本。爾時我發心念作除災"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "法大風便止。去船周迴可一里餘風水不動。"),React.DOM.br(null), 
React.DOM.span( {className:"l"}, "船上諸人皆歸於我。漸漸發來得至此岸來"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "到此國。於開元七年中至於西京。一行禪師"),React.DOM.br(null), 
React.DOM.span( {className:"l"}, "求我灌頂。聞有此異希有法門乃令伊舍羅"),React.DOM.br(null), 
React.DOM.span( {className:"l"}, "譯爲漢文。一行等乃親自筆受。一依梵本次"),React.DOM.br(null),
React.DOM.span( {className:"l"}, "第而述其意不失句義未圓。此以竊觀諸修"),React.DOM.br(null), 
React.DOM.span( {className:"l"}, "行者縱有尋讀莫知所從。又淺智愚識亦爲"),React.DOM.br(null)
      )
    );
  }
});
...
require.register("cbeta2014/index.js", function(exports, require, module){
...
require.alias("ksanaforge-boot/index.js", "cbeta2014/deps/boot/index.js");
require.alias("ksanaforge-boot/index.js", "cbeta2014/deps/boot/index.js");
require.alias("ksanaforge-boot/index.js", "boot/index.js");
require.alias("ksanaforge-boot/index.js", "ksanaforge-boot/index.js");
require.alias("brighthas-bootstrap/dist/js/bootstrap.js", "cbeta2014/deps/bootstrap/dist/js/bootstrap.js");
require.alias("brighthas-bootstrap/dist/js/bootstrap.js", "cbeta2014/deps/bootstrap/index.js");
...
require.alias("ksana-document/index.js", "cbeta2014/deps/ksana-document/index.js");
require.alias("ksana-document/document.js", "cbeta2014/deps/ksana-document/document.js");
require.alias("ksana-document/api.js", "cbeta2014/deps/ksana-document/api.js");
require.alias("ksana-document/xml.js", "cbeta2014/deps/ksana-document/xml.js");
require.alias("ksana-document/template_accelon.js", "cbeta2014/deps/ksana-document/template_accelon.js");
require.alias("ksana-document/persistent.js", "cbeta2014/deps/ksana-document/persistent.js");
require.alias("ksana-document/tokenizers.js", "cbeta2014/deps/ksana-document/tokenizers.js");
require.alias("ksana-document/markup.js", "cbeta2014/deps/ksana-document/markup.js");
require.alias("ksana-document/typeset.js", "cbeta2014/deps/ksana-document/typeset.js");
require.alias("ksana-document/sha1.js", "cbeta2014/deps/ksana-document/sha1.js");
require.alias("ksana-document/users.js", "cbeta2014/deps/ksana-document/users.js");
require.alias("ksana-document/customfunc.js", "cbeta2014/deps/ksana-document/customfunc.js");
require.alias("ksana-document/configs.js", "cbeta2014/deps/ksana-document/configs.js");
require.alias("ksana-document/projects.js", "cbeta2014/deps/ksana-document/projects.js");
require.alias("ksana-document/indexer.js", "cbeta2014/deps/ksana-document/indexer.js");
require.alias("ksana-document/indexer_kd.js", "cbeta2014/deps/ksana-document/indexer_kd.js");
require.alias("ksana-document/kdb.js", "cbeta2014/deps/ksana-document/kdb.js");
require.alias("ksana-document/kdbfs.js", "cbeta2014/deps/ksana-document/kdbfs.js");
require.alias("ksana-document/kdbw.js", "cbeta2014/deps/ksana-document/kdbw.js");
require.alias("ksana-document/kdb_sync.js", "cbeta2014/deps/ksana-document/kdb_sync.js");
require.alias("ksana-document/kdbfs_sync.js", "cbeta2014/deps/ksana-document/kdbfs_sync.js");
require.alias("ksana-document/html5fs.js", "cbeta2014/deps/ksana-document/html5fs.js");
require.alias("ksana-document/kse.js", "cbeta2014/deps/ksana-document/kse.js");
require.alias("ksana-document/kde.js", "cbeta2014/deps/ksana-document/kde.js");
require.alias("ksana-document/boolsearch.js", "cbeta2014/deps/ksana-document/boolsearch.js");
require.alias("ksana-document/search.js", "cbeta2014/deps/ksana-document/search.js");
require.alias("ksana-document/plist.js", "cbeta2014/deps/ksana-document/plist.js");
require.alias("ksana-document/excerpt.js", "cbeta2014/deps/ksana-document/excerpt.js");
require.alias("ksana-document/link.js", "cbeta2014/deps/ksana-document/link.js");
require.alias("ksana-document/tibetan/wylie.js", "cbeta2014/deps/ksana-document/tibetan/wylie.js");
require.alias("ksana-document/languages.js", "cbeta2014/deps/ksana-document/languages.js");
require.alias("ksana-document/diff.js", "cbeta2014/deps/ksana-document/diff.js");
require.alias("ksana-document/xml4kdb.js", "cbeta2014/deps/ksana-document/xml4kdb.js");
require.alias("ksana-document/buildfromxml.js", "cbeta2014/deps/ksana-document/buildfromxml.js");
require.alias("ksana-document/tei.js", "cbeta2014/deps/ksana-document/tei.js");
require.alias("ksana-document/concordance.js", "cbeta2014/deps/ksana-document/concordance.js");
require.alias("ksana-document/regex.js", "cbeta2014/deps/ksana-document/regex.js");
require.alias("ksana-document/index.js", "cbeta2014/deps/ksana-document/index.js");
require.alias("ksana-document/index.js", "ksana-document/index.js");
require.alias("ksana-document/index.js", "ksana-document/index.js");
require.alias("ksanaforge-kse/index.js", "cbeta2014/deps/kse/index.js");
require.alias("ksanaforge-kse/rpc.js", "cbeta2014/deps/kse/rpc.js");
require.alias("ksanaforge-kse/rpc_yase.js", "cbeta2014/deps/kse/rpc_yase.js");
require.alias("ksanaforge-kse/rpc_document.js", "cbeta2014/deps/kse/rpc_document.js");
require.alias("ksanaforge-kse/ksana.js", "cbeta2014/deps/kse/ksana.js");
require.alias("ksanaforge-kse/ksana_promise.js", "cbeta2014/deps/kse/ksana_promise.js");
require.alias("ksanaforge-kse/index.js", "cbeta2014/deps/kse/index.js");
require.alias("ksanaforge-kse/index.js", "kse/index.js");
require.alias("ksanaforge-kse/index.js", "ksanaforge-kse/index.js");
require.alias("cbeta2014-main/index.js", "cbeta2014/deps/main/index.js");
require.alias("cbeta2014-main/index.js", "cbeta2014/deps/main/index.js");
require.alias("cbeta2014-main/index.js", "main/index.js");
require.alias("cbeta2014-main/index.js", "cbeta2014-main/index.js");
require.alias("cbeta2014-comp1/index.js", "cbeta2014/deps/comp1/index.js");
require.alias("cbeta2014-comp1/index.js", "cbeta2014/deps/comp1/index.js");
require.alias("cbeta2014-comp1/index.js", "comp1/index.js");
require.alias("cbeta2014-comp1/index.js", "cbeta2014-comp1/index.js");
require.alias("cbeta2014-maintext/index.js", "cbeta2014/deps/maintext/index.js");
require.alias("cbeta2014-maintext/index.js", "cbeta2014/deps/maintext/index.js");
require.alias("cbeta2014-maintext/index.js", "maintext/index.js");
require.alias("cbeta2014-maintext/index.js", "cbeta2014-maintext/index.js");
require.alias("ksanaforge-fileinstaller/index.js", "cbeta2014/deps/fileinstaller/index.js");
require.alias("ksanaforge-fileinstaller/index.js", "cbeta2014/deps/fileinstaller/index.js");
...
require.alias("ksanaforge-checkbrowser/index.js", "cbeta2014/deps/checkbrowser/index.js");
require.alias("ksanaforge-checkbrowser/index.js", "cbeta2014/deps/checkbrowser/index.js");
require.alias("ksanaforge-checkbrowser/index.js", "checkbrowser/index.js");
require.alias("ksanaforge-checkbrowser/index.js", "ksanaforge-checkbrowser/index.js");
require.alias("ksanaforge-htmlfs/index.js", "cbeta2014/deps/htmlfs/index.js");
require.alias("ksanaforge-htmlfs/index.js", "cbeta2014/deps/htmlfs/index.js");
require.alias("ksanaforge-htmlfs/index.js", "htmlfs/index.js");
require.alias("ksanaforge-htmlfs/index.js", "ksanaforge-htmlfs/index.js");
require.alias("cbeta2014/index.js", "cbeta2014/index.js");
if (typeof exports == 'object') {
  module.exports = require('cbeta2014');
} else if (typeof define == 'function' && define.amd) {
  define(function(){ return require('cbeta2014'); });
} else {
  window['cbeta2014'] = require('cbeta2014');
}})();